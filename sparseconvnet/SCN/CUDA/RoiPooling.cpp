...
void cuda_RoiPooling_updateOutput(
  ...
  cuda_RoiPooling_ForwardPass<T>(iF, oF, nPlanes, input_features.size(1),
                                 output_features.size(1), _rules);
}
template <typename T, Int Dimension>
void cuda_RoiPooling_updateGradInput(
    /*long*/ at::Tensor &inputSize, /*long*/ at::Tensor &outputSize,
  ...
  cuda_RoiPooling_BackwardPass<T>(iF, diF, oF, doF, nPlanes,
